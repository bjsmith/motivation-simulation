...
#this model sets up the absolute minimum number of values needed to model the saltrat model.
#hopefully just kappa_{Na,T}, r_{Na,T}
def setup_minimal_salt_rat_model():
    ...
    bb=BisbasModel(
        ...
        baseline_pos_expectancy=1,
        baseline_neg_expectancy=0,
        baseline_action_threshold=0,
        learning_rate=0.00,
        action_tendency_persistence=0.0,
        satiation_power=0.00,
    ...
    bb.action_state[i_moderate_solution, i_salt] = 0
    bb.action_state[i_strong_solution, i_salt] = 0

    bb.state_action[i_pleasant_taste,i_moderate_solution] = 1
    bb.state_action[i_pleasant_taste, i_strong_solution] = -1
